...
{    
    ...
    private JLabel Label7, Label8,Label9,Label10,Label11;
    private JTextField Text1, Text2, Text3,Text4,Text5,Text6;
    private JTextField Text7, Text8, Text9,Text10,Text11;
    ...
    {
        printFile = new PrintWriter(new FileWriter("HeatingReport.txt", true));
    ...
    private class CalculateButtonListener implements ActionListener
    {
        ...
        {                      
           ...
           {
               // default for empty paramters
               furnaceType = "gas";
               Input11 = true;
            }
           // makes sure the user enters the furnace type correctly
           ...
           try{    
               ...
               Input6 = true;
               if(size < 1){
                   System.out.println("Please enter a valid room area (1-4500). \n");
                   Text7.setText("");
                   Input6 = false;    
                }
               else if(size > 4500) {
           ...
           try{    
               ...
               Input7 = true;
               if(overheat < 1){
                   System.out.println("Please enter a postive overheat greater than one. \n");
                   Text8.setText("");
                   Input7 = false;                   
                }
            }
               ...
               if(str7.equals("")){
                   ...
                   System.out.println("Please enter a postive overheat greater than zero. \n");
                   Text8.setText("");
                   Input7 = false;
                   }    
            } 
           ...
           try{
               ...
               Input8 = true;
               if(freq < 1){
                   System.out.println("Please enter a postive frequency value greater than zero. \n");
                   Text9.setText("");
                   Input8 = false;
               }                 
            }
           ...
           try{
               ...
               Input10 = true;
               if(yearBuilt < 0){
                   System.out.println("Please enter a year value greater than one. \n");
                   Text11.setText("");
                   Input10 = false;
                }
            }
               ...
               if(str10.equals("")){
                   ...
                   System.out.println("Please enter a year value greater than zero. \n");
                   Text11.setText("");
                   Input10 = false;
                   }
            }
           ...
           if(Input1 && Input2 && Input3 && Input4 && Input5 && Input6 && Input7 && Input8 && Input9 && Input10 && Input11){
               ...
               // Format starting settings in text window and file
               //System.out.println("%s %-20.1f %s %-10s %s %-7s %s %-7s %s %-7s %n", "Furnace: capacity =", cap, "Efficiency =", percentFormat.format(eff), "pilot on =", "true", "heating =", heating, "type = ", furnaceType);
               ...
               printFile.printf("%s %-20.1f %s %-10s %s %-7s %s %-7s %s %-7s %n", "Furnace: capacity =", cap, "Efficiency =", percentFormat.format(eff), "pilot on =", "true", "heating =", heating, "type = ", furnaceType);
               printFile.printf("%s %-5d %s %-6.1f %s %-9.1f %s %-12.1f %s %-7.1f %n", "Room  Year Built:", yearBuilt, "Temperature =", in, "Area (Sq ft)=", size, "SHC =", 4.0, "BLC =", 1.0);
               printFile.println("Environment:   Temperature = " + out);
               printFile.println("Thermostat:    Setting = " + set + "   Overheat = " + overheat);
               printFile.println("Starting simulation:       Display frequency (secs) = " + freq + "   Runtime (sec): " + length + "\n");
               printFile.printf("%-18s %-18s %-18s %-18s %n", "Time", "Inside", "Outside", "Furnace Status");
               printFile.printf("%-18s %-18s %-18s %-18s %n", "----------", "----------", "----------", "---------------");
   ...
   public class TimerTest 
   {
    ...
    private  final int TIMER_DELAY = 300; // time before new print
    ...
    // Call all the methods for computing heat and print onto screen and file
    private class TimerTestListener implements ActionListener
    {
        ...
        {                           
            ...
            {                 
                ...
                printFile.printf("%-18d %-18.2f %-18.2f %-18s %n", time, in, out, "On");
            ...
            {                
                ...
                printFile.printf("%-18d %-18.2f %-18.2f %-18s %n", time, in, out, "Off");
